...
std::string error_400_form = "Your request has bad syntax or is inherently impossible to satisfy.\n";
std::string error_403_title = "Forbidden";
std::string error_403_form = "You do not have permission to get file from this server.\n";
...
std::string error_500_form = "There was an unusual problem serving the requested file.\n";

// 网站的根目录
std::string doc_root = "/home/kumo/Desktop/PRO_WebServer/resources";

// 静态变量的初始化
int http_conn::m_user_num = 0;  // 所有的客户数
int http_conn::m_epollfd = -1;  // 所有socket上的事件都被注册到同一个epoll内核事件中
...
void addfd(int epollfd, int fd, bool one_shot)
{
    ...
    if (one_shot)
    {
        // 使用EPOLLONESHOT事件防止同一个通信被不同的线程处理
...
bool http_conn::process_write(HTTP_CODE ret)
{
    ...
    case INTERNAL_ERROR:
        ...
        add_headers(strlen(error_500_form.c_str()));
    ...
    case BAD_REQUEST:
        ...
        add_headers(strlen(error_400_form.c_str()));
    ...
    case NO_RESOURCE:
        ...
        add_headers(strlen(error_404_form.c_str()));
    ...
    case FORBIDDEN_REQUEST:
        ...
        add_headers(strlen(error_403_form.c_str()));
